                                    ...
                                    <div class="d-flex align-items-center justify-content-between w-100">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dateSorter">
                                                ...
                                                <div class="dropdown-item" id="market-overview_3">Monthly
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mt-3 py-2 border-bottom">
                                        <img class="img-sm rounded-circle" src="backend/images/faces/face3.jpg"
                                            alt="profile image">
                                    ...
                                    <div class="d-flex py-2 border-bottom">
                                        <img class="img-sm rounded-circle" src="backend/images/faces/face4.jpg"
                                            alt="profile image">
                                        <div class="wrapper ml-2">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="timeline">
                                <li class="timeline-item">
                                    <p class="timeline-content"><a href="#">Ben Tossell</a> assign you a
                                        task
                                    </p>

<footer class="site_footer">
                ...
                <div class="col col-lg-3 col-md-6 col-sm-6">
                    <div class="site_logo">
                        <a class='site_link' href='index.html'>
                            <img src="frontend/images/logo/site_logo_white.png"
                        ...
                        <ul class="store_btns unordered_list_block">
                            <li>
                                <a href="https://www.apple.com/app-store/" target="_blank">
                                    <img src="frontend/images/app_store.png" alt="App Store">
                                </a>
                            </li>
                            <li>
                                <a href="https://play.google.com/store/" target="_blank">
                                    <img src="frontend/images/google_play.png" alt="Google Play">
                                </a>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="container">
        <div class="footer_bottom">
            ...
            <p class="copyright_text mb-0">© Copyrights 2022 <a href='index.html'>Udemo</a> All rights reserved.
            </p>
        </div>
    </div>
</footer>
...
<script src="frontend/js/bootstrap-dropdown-ml-hack.js"></script>
<script src="frontend/js/cursor.js"></script>
<script src="frontend/js/slick.min.js"></script>
<script src="frontend/js/tilt.min.js"></script>

...
@section('main-container')
    <main class="page_content">
                ...
                <div class="row justify-content-lg-between">
                    ...
                    <div class="col col-lg-8">
                        <div class="details_image">
                            <img src="assets/images/blogs/blog_img_6.jpg" alt="Blog Image">
                        </div>
                        ...
                        <div class="comment_area">
                            ...
                            <ul class="comments_list unordered_list_block">
                                <li>
                                    <div class="comment_item">
                                        <div class="comment_hero_thumbnail">
                                            <img src="assets/images/meta/thumbnail_img_1.png" alt="Thumbnail">
                                        </div>
                                    ...
                                    <ul class="comments_list unordered_list_block">
                                        <li>
                                            <div class="comment_item">
                                                <div class="comment_hero_thumbnail">
                                                    <img src="assets/images/meta/thumbnail_img_2.png"
                                ...
                                <li>
                                    <div class="comment_item">
                                        <div class="comment_hero_thumbnail">
                                            <img src="assets/images/meta/thumbnail_img_2.png" alt="Thumbnail">
                                        </div>
                                        <div class="comment_hero_content">
                                            <h4 class="comment_hero_name">Benjami Costa</h4>
                                            <ul class="comments_post_time unordered_list">
                        ...
                        <aside class="sidebar">
                            ...
                            <div class="widget recent_post">
                                ...
                                <ul class="unordered_list_block">
                                    <li>
                                        <a class='blog_item_small' href='blog_details.html'>
                                            <span class="item_image">
                                                <img src="assets/images/blogs/small_blog_image_1.png" alt="Blog Image">
                                            </span>
                                    ...
                                    <li>
                                        <a class='blog_item_small' href='blog_details.html'>
                                            <span class="item_image">
                                                <img src="assets/images/blogs/small_blog_image_2.png" alt="Blog Image">
                                            </span>
                                            <span class="item_content">
                                                <strong class="item_title d-block">
                                                    there are a few easy changes we can make
                                    ...
                                    <li>
                                        <a class='blog_item_small' href='blog_details.html'>
                                            <span class="item_image">
                                                <img src="assets/images/blogs/small_blog_image_3.png" alt="Blog Image">
                                            </span>
                                            <span class="item_content">
                                                <strong class="item_title d-block">
                                                    there are a few easy changes we can make
                            ...
                            <div class="widget">
                                <a class="advertisement_banner tilt" href="#!" data-cursor="-opaque">
                                    <img src="assets/images/banner/advertisement_banner_img_1.jpg"
        ...
        <section class="getstart_section decoration_wrap text-center">
            ...
            <div class="deco_item deco_img_1" data-parallax='{"y" : -130, "smoothness": 6}'>
                <img src="assets/images/shapes/line_shape_4.png" alt="Shape Image">
            </div>
    ...
    <footer class="site_footer">
                    ...
                    <div class="col col-lg-3 col-md-6 col-sm-6">
                        <div class="site_logo">
                            <a class='site_link' href='index.html'>
                                <img src="assets/images/logo/site_logo_white.png"
                                    alt="Education, Online Course, LMS Creative">
                            </a>
                        </div>
                        <p>
                            Not everyone can afford to quit their job to learn full-time. We’re here to make coding more
        ...
        <div class="container">
            <div class="footer_bottom">
                ...
                <p class="copyright_text mb-0">© Copyrights 2022 <a href='index.html'>Udemo</a> All rights reserved.</p>
            </div>
        </div>
    </footer>
    <!-- Footer Section - End
    ...
    <!-- Cursor - jquery include -->
    <script src="assets/js/cursor.js"></script>

    <!-- Slick Slider - jquery include -->
    ...
    <!-- Mirrored from udemo-html.netlify.app/blog_details by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 May 2024 16:49:42 GMT -->
